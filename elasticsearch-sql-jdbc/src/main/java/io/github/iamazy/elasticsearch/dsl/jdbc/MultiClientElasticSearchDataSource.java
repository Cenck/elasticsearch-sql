 ...
 * 多restclinet的es数据源
 */
public class MultiClientElasticSearchDataSource extends DriverManagerDataSource implements ElasticDataSource {
    ...
    public MultiClientElasticSearchDataSource() {
    }

    public MultiClientElasticSearchDataSource(String url, boolean suppressClose) {
        super(url);
        this.suppressClose = suppressClose;
    }

    /*** url,username,password创建restclient */
